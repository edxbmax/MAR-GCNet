...
class DownLoadECGData:
    ...
    def preprocess_data(self):
        ...
        data, labels, Y, _ = select_data(data, labels, self.task, self.min_samples, self.datafolder)
        ...
        X_train, X_val, X_test = preprocess_signals(self.datafolder, self.task, X_train, X_val, X_test)

        return X_train, y_train, X_val, y_val, X_test, y_test


def load_datasets(datafolder=None, experiment=None, bs = 64):
    '''
    ...
    val_dataloader = DataLoader(ds_val, batch_size=bs, shuffle=False)
