...
class InceptionTime(nn.Module):
    def __init__(self, input_channels=12, num_classes=10):
        super(InceptionTime, self).__init__()

        self.BaseBlock1 = BaseBlock(input_channels)
        self.BaseBlock2 = BaseBlock(128)
        self.BaseBlock3 = BaseBlock(128)

        self.relu = nn.ReLU(inplace=True)
        self.conv1 = nn.Conv1d(input_channels, 128, kernel_size=1, stride=1, bias=False)
